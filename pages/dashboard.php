...
?>
<script>window.WATTWATCH_BASE_URL = <?= json_encode(BASE_URL) ?>;</script>
...
<div class="card-grid">
  ...
  <div class="stat-card">
    ...
    <div><p class="stat-label">Total Energy (Today)</p>
      <p class="stat-value"><?= formatKwh($totalEnergyToday) ?></p>
      <p class="stat-sub">From 12:00 AM</p></div>
  </div>
  <div class="stat-card">
    <div class="stat-icon amber">📅</div>
    <div><p class="stat-label">Total Energy (This Month)</p>
      <p class="stat-value"><?= formatKwh($totalEnergyMonth) ?></p>
  ...
  <div>
    ...
    <div class="panel">
      <div class="panel-head">
        ...
        <a class="view-all" href="<?= BASE_URL ?>/pages/monitoring.php">View all</a>
      </div>
  ...
  <div>
    <div class="panel">
      <div class="panel-head">
        ...
        <a class="view-all" href="<?= BASE_URL ?>/pages/anomalies.php">View all</a>
      </div>
      ...
      <a class="btn btn-primary" style="width:100%;justify-content:center;margin-top:14px;" href="<?= BASE_URL ?>/pages/anomalies.php">View All Anomalies</a>
    </div>
    ...
    <div class="panel">
      ...
      <div class="list-row">
        ...
        <span class="row-sub"><?= timeAgo($log['created_at']) ?></span>
      </div>
      <?php endforeach; ?>
