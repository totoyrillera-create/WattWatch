...
requirePermission('manage_thresholds');
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    logActivity($user['user_id'], 'update_threshold', "Set threshold for equipment #$equipmentId to $min-$max W");
...
$pageSubtitle = 'Set the normal power range used for anomaly detection';
