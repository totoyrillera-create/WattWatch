...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'acknowledge') {
        ...
        logActivity($user['user_id'], 'resolve_anomaly', 'Resolved anomaly #' . $id);
...
$pageTitle = 'Anomalies';
$pageSubtitle = 'Threshold-based anomaly detection log';
